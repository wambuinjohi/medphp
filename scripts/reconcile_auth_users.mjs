 ...
 * 
 * This script reconciles authentication users via med.wayrus.co.ke/api.php
 * 
 * Usage:
 * VITE_EXTERNAL_API_URL=https://med.wayrus.co.ke/api.php DRY_RUN=1 node scripts/reconcile_auth_users.mjs
 */
