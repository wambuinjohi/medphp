...
import { useCreateSupplier } from '@/hooks/useDatabase';
...
export function CreateSupplierModal({ open, onOpenChange, onSuccess, companyId: propCompanyId }: CreateSupplierModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success(`Supplier ${created?.name || formData.name} created successfully!`);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new supplier to your system. Fill in the supplier details below.
          </DialogDescription>
        </DialogHeader>
