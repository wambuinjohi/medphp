...
const DEFAULT_TERMS_TEXT = `
  <div style="text-align:left; font-size:11px; color:#333; line-height:1.3;">
    <div style="margin-bottom:4px;">
      <strong>Prepared By:</strong>……………………………………………………….………………….&nbsp;&nbsp;&nbsp;
      <strong>Checked By:</strong>………………………………………………...……….
    </div>
    <strong>Terms and regulations</strong>
    <ol style="margin-top:4px; margin-bottom:4px; padding-left:18px; line-height:1.3;">
      <li style="margin-bottom:2px;">The company shall have general as well as particular lien on all goods for any unpaid A/C</li>
      <li style="margin-bottom:2px;">Cash transactions of any kind are not acceptable. All payments should be made by cheque , MPESA, or Bank transfer only</li>
      <li style="margin-bottom:2px;">Claims and queries must be lodged with us within 21 days of dispatch of goods, otherwise they will not be accepted back</li>
      <li style="margin-bottom:2px;">Where applicable, transport will be invoiced separately</li>
      <li style="margin-bottom:2px;">The company will not be responsible for any loss or damage of goods on transit collected by the customer or sent via customer's courier A/C</li>
