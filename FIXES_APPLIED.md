...
The backend at `https://accounts.heal.co.ke/api.php` needs to add CORS headers:
...
The app will use this instead of the default `https://accounts.heal.co.ke/api.php`.
